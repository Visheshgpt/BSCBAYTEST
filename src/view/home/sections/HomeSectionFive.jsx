                ...
                <p className='mb-0 text-white-2'>
                  <ul className='nav flex-column'>
                    <li className='py-2'>
                      ...
                      />
                      <span>
                        We Provide a <b>plethora of tools for BSC Ecosystem</b>{' '}
                        enabling Investors and Projects Owners power to use the
                        BSC network to its fullest
                      </span>
                    </li>
                    <li className='py-2'>
                      <img
                    ...
                    <li className='py-2'>
                      ...
                      <span>
                        ...
                        <b>get a wide array of trusted tools</b> to use and open
                        gates to a vast array of investors.
                      </span>
                    </li>
                    <li className='py-2'>
                      <img
            ...
            <Row className='justify-content-center' style={{ gap: 15 }}>
              {dataArr.map((data) => (
                <div className='box-3 border border-secondary'>
                  ...
                  <span className='text-small text-white-3'>{data.title}</span>
                </div>
              ))}
            </Row>
          </div>
