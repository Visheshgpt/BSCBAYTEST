          ...
          <div>
            ...
            <p className='px-0 col-xl-9 mb-4'>
              <ul className='ps-3'>
                ...
                <li>
                  <b>$BSCB works</b> on an autonomous frictionless yield farming
                  and liquidity generation protocol beautifully designed to
                  seamlessly integrate various parts of the ecosystem.
                </li>
                <li>
                  For Investors, It's as simple as holding <b> $BSCB tokens</b>{' '}
                  in their wallet and getting more <b>$BSCB & $BNB.</b>{' '}
                  Investors can yeild daily rewards based on their investment
                  through the available Dapp.
                </li>
                <li>
            ...
            <div className='d-flex mb-4 px-0 col-lg-9 col-xl-8 col-xxl-7'>
              ...
              <div className='flex-fill'>
                <div className='title-small mb-1'>Stake Holders Rewards</div>
                <p className='mb-0'>
                  <ul className='nav flex-column'>
                    <li className='py-2'>
                      <div className='mb-1'>
                        ​<b>50%</b> Earnings from every project launched will be
                    ...
                    <li className='py-2'>
                      <div className='mb-1'>
                        ​<b>50%</b> of Analytical Tie ups & Promotional Earning
                    ...
                    <li className='py-2'>
                      <div className='mb-1'>
                        ​<b>30%</b> of Mint Factory Earning will be distributed
                        to Investors.
                      </div>
                      <ProgressBar variant='warning' now={30} />
                    </li>
