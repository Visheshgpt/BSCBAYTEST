      ...
      <Container>
        <div className='text-center'>
          ...
          <p className='mt-3 mb-4 px-0 col-md-11 col-lg-10 mx-auto'>
            ...
            traditional banks and go straight to DeFi. We’re also making weekly
            donations through two world-class charities. Plus look out for
            community events, merchandise, and more coming your way soon!
          </p>
