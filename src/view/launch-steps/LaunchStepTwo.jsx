...
const LaunchStepTwo = () => {
  return (
    <section className='flex-fill bg-color-5 text-white-2 d-flex align-items-center justify-content-center position-relative'>
      ...
      <div className='bg-secondary rounded-lg-2 px-md-5 px-3 pt-3 pt-md-5 pb-4 mx-2 col-md-11 col-lg-10 col-xl-8 col-xxl-7 my-5'>
        <div className='mb-3'>
          <div className='title-small text-white fw-bold'>Disclaimer</div>
        </div>
        <p className='mb-4'>
          Trading cryptocurrencies carries a{' '}
          <span className='text-primary'>high level of risk,</span> and may not
          ...
          you should not invest money that you cannot afford to lose. ICO's,
          1E0's, STO's and any other form of offering will not guarantee a
        ...
        <p className='mb-4'>
          ...
          affiliates will not accept liability for any loss or damage, including
        ...
        <p className='mb-4'>
          :01 1 C I The Hodltoken.net and its affiliates makes no representation
          or warranties as to the accuracy and or timelines of the information
          contained herein. A qualified professional should be consulted before
        ...
        <div className='mt-4 mb-2 px-0 col-md-6 col-lg-3 col-xl-3 mx-auto'>
          <Link to='/wallet/step-three' className='btn btn-color py-2 w-100'>
